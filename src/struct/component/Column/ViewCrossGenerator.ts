...
export class ColumnViewCrossGenerator{
  protected yLeader = 0;
  ...
  generate(fig: FigureContent, t: ColumnStruct, rebars: ColumnRebar): CompositeItem{
    ...
    this.dot = divideByCount(-t.w/2+as, t.w/2-as, rebars.along.singleCount + 1);
  ...
  protected cross(fig: FigureContent, comp: CompositeItem, t: ColumnStruct, rebars: ColumnRebar): void{
    this.yLeader -= 3*fig.h;
