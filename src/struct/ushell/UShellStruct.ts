...
export class UShellStruct {
  ...
  get cantCount(): number {
    if (this.cantLeft + this.cantRight === 0) {
      return 0;
    } else if (this.cantLeft * this.cantRight === 0) {
      return 1;
    } else {
      return 2;
    }
  ...
  isEndFigureExist(): boolean {
    return this.cantRight * this.cantLeft === 0;
  }
  isEndCantFigureExist(): boolean {
    return this.cantRight + this.cantLeft > 0;
  }
  hasUnCant(): boolean {
...
class Shell extends Part<UShellStruct> {
  r = 0;
  t = 0;
  hd = 0;
  hb = 0;
...
class EndSect extends Part<UShellStruct> {
  b = 0;
  hd = 0;
  hs = 0;
  w = 0;
...
class TopBeam extends Part<UShellStruct> {
  hd = 0;
  hs = 0;
  w = 0;
}

class WaterStop extends Part<UShellStruct> {
  h = 0;
  w = 0;
}

class Bar extends Part<UShellStruct> {
  h = 0;
  w = 0;
}

class Support extends Part<UShellStruct> {
  h = 0;
  w = 0;
}
