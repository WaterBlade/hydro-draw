...
export class PileRebarBuilder extends PileContext {
  build(): void {
    this.buildMain();
    this.buildStir();
    this.buildStirTop();
    ...
    bar
      ...
      .setForm(
        new RebarPathForm(bar.diameter)
          .lineBy(1.5, 0.8)
          .dimLength(bar.diameter * this.rebars.anchorFactor, Side.Right)
          .guideLineBy(-1, 0)
          .dimAngle(t.topAngle)
          .lineBy(4, 0)
